...
class CodeManifestTools {
  ...
  public register(server: McpServer): void {
    // Register all tools
    server.registerTool('mcp_code_manifest_extract_class_info', {
    ...
    }, async (args) => this.handleExtractClassInfo(args));

    server.registerTool('mcp_code_manifest_find_files', {
    ...
    }, async (args) => this.handleFindFiles(args));
    ...
    server.registerTool('mcp_code_manifest_compare_manifests', {
    ...
    }, async (args) => this.handleCompareManifests(args));

    server.registerTool('mcp_code_manifest_compare_with_repository', {
    ...
    }, async (args) => this.handleCompareWithRepository(args));

    server.registerTool('mcp_code_manifest_create_backup', {
    ...
    }, async (args) => this.handleCreateBackup(args));

    server.registerTool('mcp_code_manifest_classify_files', {
    ...
    }, async (args) => this.handleClassifyFiles(args));

    server.registerTool('mcp_code_manifest_get_prompt_content', {
    ...
    }, async (args) => this.handleGetPromptContent(args));
  }
...
export function registerTools(server: McpServer) {
  new CodeManifestTools().register(server)
}
