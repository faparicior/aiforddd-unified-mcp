...
export function registerTools() {
  ...
  globalToolRegistry.registerTool({
    name: parseMarkdownTableTool.name,
  ...
  globalToolRegistry.registerTool({
    name: countMarkdownTableRowsTool.name,
  ...
  globalToolRegistry.registerTool({
    name: filterAndCountRowsTool.name,
  ...
  globalToolRegistry.registerTool({
    name: getFirstRowByColumnTool.name,
  ...
  globalToolRegistry.registerTool({
    name: getMultipleRowsByColumnTool.name,
  ...
  globalToolRegistry.registerTool({
    name: getMultipleRowsByMultipleColumnsTool.name,
  ...
  globalToolRegistry.registerTool({
    name: updateRowByMatchTool.name,
  ...
  globalToolRegistry.registerTool({
    name: updateRowByColumnTool.name,
  ...
  globalToolRegistry.registerTool({
    name: getUniqueColumnValuesTool.name,
